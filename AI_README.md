...
5. **Use the test helpers** they are designed to reduce code bloat and provide faster error tracking -- **especially** use those in pkg/core/universal_test_helpers.go
6. **Testing Philosophy: Keep Tests Simple, Clear, and Fast to Fail**
