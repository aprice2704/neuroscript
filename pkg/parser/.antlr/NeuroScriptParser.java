...
public class NeuroScriptParser extends Parser {
	...
	public static final int
		...
		RULE_expression_statement = 23, RULE_block_statement = 24, RULE_on_stmt = 25, 
		RULE_error_handler = 26, RULE_event_handler = 27, RULE_clearEventStmt = 28, 
		RULE_lvalue = 29, RULE_lvalue_list = 30, RULE_set_statement = 31, RULE_call_statement = 32, 
		RULE_return_statement = 33, RULE_emit_statement = 34, RULE_fail_statement = 35, 
	...
	public final Command_statement_listContext command_statement_list() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & -152591381397477404L) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & 2152017939L) != 0)) {
				{
				{
				setState(195);
				command_body_line();
	...
	public final Non_empty_statement_listContext non_empty_statement_list() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & -150339581583790108L) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & 2152017939L) != 0)) {
				{
				{
				setState(287);
				body_line();
	...
	public final On_stmtContext on_stmt() throws RecognitionException {
		...
		enterRule(_localctx, 50, RULE_on_stmt);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(330);
	...
	public final Error_handlerContext error_handler() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_error_handler);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(335);
	...
	public final Event_handlerContext event_handler() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_event_handler);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ClearEventStmtContext clearEventStmt() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_clearEventStmt);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(356);
	...
	public final Lvalue_listContext lvalue_list() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_lvalue_list);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Set_statementContext set_statement() throws RecognitionException {
		...
		enterRule(_localctx, 62, RULE_set_statement);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(383);
	...
	public final Call_statementContext call_statement() throws RecognitionException {
		...
		enterRule(_localctx, 64, RULE_call_statement);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(388);
	...
	public final Return_statementContext return_statement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -2467723074775007068L) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & 4534291L) != 0)) {
				{
				setState(392);
				expression_list();
				}
	...
	public final Emit_statementContext emit_statement() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_emit_statement);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(395);
	...
	public final Unary_exprContext unary_expr() throws RecognitionException {
		...
		try {
			...
			case TILDE:
				...
				setState(528);
				_la = _input.LA(1);
				if ( !(((((_la - 41)) & ~0x3f) == 0 && ((1L << (_la - 41)) & 68987928673L) != 0)) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
