...
import "github.com/aprice2704/neuroscript/pkg/parser"
...
var treeToolsToRegister = []runtime.tool.ToolImplementation{
	// --- Load/Save ---
	{
		Spec: runtime.tool.ToolSpec{
			...
			Args: []runtime.tool.ArgSpec{
				{Name: "json_string", Type: parser.ArgTypeString, Required: true, Description: "The JSON data as a string."},
			},
	...
	},
	{
		Spec: runtime.tool.ToolSpec{
			...
			Category:	"Tree Manipulation",
			Args: []runtime.tool.ArgSpec{
				{Name: "tree_handle", Type: parser.ArgTypeString, Required: true, Description: "Handle to the tree structure."},
			},
			ReturnType:		parser.ArgTypeString,
	...
	// --- Navigation & Access ---
	{
		Spec: runtime.tool.ToolSpec{
			...
			Args: []runtime.tool.ArgSpec{
				{Name: "tree_handle", Type: parser.ArgTypeString, Required: true, Description: "Handle to the tree structure."},
				{Name: "node_id", Type: parser.ArgTypeString, Required: true, Description: "The unique ID of the node to retrieve."},
			},
	...
	},
	{
		Spec: runtime.tool.ToolSpec{
			...
			Args: []runtime.tool.ArgSpec{
				{Name: "tree_handle", Type: parser.ArgTypeString, Required: true, Description: "Handle to the tree structure."},
				{Name: "node_id", Type: parser.ArgTypeString, Required: true, Description: "ID of the node whose parent is sought."},
			},
			ReturnType:		parser.ArgTypeString,
	...
	},
	{
		Spec: runtime.tool.ToolSpec{
			...
			Args: []runtime.tool.ArgSpec{
				{Name: "tree_handle", Type: parser.ArgTypeString, Required: true, Description: "Handle to the tree structure."},
				{Name: "node_id", Type: parser.ArgTypeString, Required: true, Description: "ID of the 'array' type parent node."},
			},
			ReturnType:		runtime.tool.ArgTypeSliceString,
	...
	// --- Modification ---
	{
		Spec: runtime.tool.ToolSpec{
			...
			Args: []runtime.tool.ArgSpec{
				{Name: "tree_handle", Type: parser.ArgTypeString, Required: true, Description: "Handle to the tree structure."},
				{Name: "node_id", Type: parser.ArgTypeString, Required: true, Description: "ID of the leaf or simple-type node to modify."},
				{Name: "value", Type: parser.ArgTypeAny, Required: true, Description: "The new value for the node."},
			},
	...
	},
	{
		Spec: runtime.tool.ToolSpec{
			...
			Category:	"Tree Manipulation",
			Args: []runtime.tool.ArgSpec{
				{Name: "tree_handle", Type: parser.ArgTypeString, Required: true, Description: "Handle for the tree structure."},
				{Name: "parent_node_id", Type: parser.ArgTypeString, Required: true, Description: "ID of the node that will become the parent."},
				{Name: "new_node_id_suggestion", Type: parser.ArgTypeString, Required: false, Description: "Optional suggested unique ID for the new node. If empty or nil, an ID will be auto-generated. Must be unique if provided."},
				{Name: "node_type", Type: parser.ArgTypeString, Required: true, Description: "Type of the new child (e.g., 'object', 'array', 'string', 'number', 'boolean', 'null', 'checklist_item')."},
				{Name: "value", Type: parser.ArgTypeAny, Required: false, Description: "Initial value if the node_type is a leaf or simple type. Ignored for 'object' and 'array' types."},
				{Name: "key_for_object_parent", Type: parser.ArgTypeString, Required: false, Description: "If the parent is an 'object' node, this key is used to link the new child in the parent's attributes. Required for object parents."},
			},
			ReturnType:		parser.ArgTypeString,
	...
	},
	{
		Spec: runtime.tool.ToolSpec{
			...
			Category:	"Tree Manipulation",
			Args: []runtime.tool.ArgSpec{
				{Name: "tree_handle", Type: parser.ArgTypeString, Required: true, Description: "Handle to the tree."},
				{Name: "node_id", Type: parser.ArgTypeString, Required: true, Description: "ID of the node to remove."},
			},
			ReturnType:		runtime.tool.ArgTypeNil,
	...
	},
	{
		Spec: runtime.tool.ToolSpec{
			...
			Args: []runtime.tool.ArgSpec{
				{Name: "tree_handle", Type: parser.ArgTypeString, Required: true, Description: "Handle for the tree structure."},
				{Name: "object_node_id", Type: parser.ArgTypeString, Required: true, Description: "Unique ID of the 'object' type node to modify."},
				{Name: "attribute_key", Type: parser.ArgTypeString, Required: true, Description: "The key (name) of the attribute to set."},
				{Name: "child_node_id", Type: parser.ArgTypeString, Required: true, Description: "The ID of an *existing* node within the same tree to associate with the key."},
			},
			ReturnType:		runtime.tool.ArgTypeNil,
	...
	},
	{
		Spec: runtime.tool.ToolSpec{
			...
			Args: []runtime.tool.ArgSpec{
				{Name: "tree_handle", Type: parser.ArgTypeString, Required: true, Description: "Handle for the tree structure."},
				{Name: "object_node_id", Type: parser.ArgTypeString, Required: true, Description: "Unique ID of the 'object' type node to modify."},
				{Name: "attribute_key", Type: parser.ArgTypeString, Required: true, Description: "The key (name) of the attribute to remove."},
			},
			ReturnType:		runtime.tool.ArgTypeNil,
	...
	// --- Metadata (Stored as string-string pairs in node.Attributes) ---
	{
		Spec: runtime.tool.ToolSpec{
			...
			Args: []runtime.tool.ArgSpec{
				{Name: "tree_handle", Type: parser.ArgTypeString, Required: true, Description: "Handle to the tree structure."},
				{Name: "node_id", Type: parser.ArgTypeString, Required: true, Description: "ID of the node to set metadata on."},
				{Name: "metadata_key", Type: parser.ArgTypeString, Required: true, Description: "The key of the metadata attribute (string)."},
				{Name: "metadata_value", Type: parser.ArgTypeString, Required: true, Description: "The value of the metadata attribute (string)."},
			},
			ReturnType:		runtime.tool.ArgTypeNil,
	...
	},
	{
		Spec: runtime.tool.ToolSpec{
			...
			Args: []runtime.tool.ArgSpec{
				{Name: "tree_handle", Type: parser.ArgTypeString, Required: true, Description: "Handle to the tree structure."},
				{Name: "node_id", Type: parser.ArgTypeString, Required: true, Description: "ID of the node to remove metadata from."},
				{Name: "metadata_key", Type: parser.ArgTypeString, Required: true, Description: "The key of the metadata attribute to remove."},
			},
			ReturnType:		runtime.tool.ArgTypeNil,
	...
	// --- Find & Render ---
	{
		Spec: runtime.tool.ToolSpec{
			...
			Args: []runtime.tool.ArgSpec{
				{Name: "tree_handle", Type: parser.ArgTypeString, Required: true, Description: "Handle to the tree structure."},
				{Name: "start_node_id", Type: parser.ArgTypeString, Required: true, Description: "ID of the node within the tree to start searching from. The search includes this node."},
				{Name: "query_map", Type: parser.ArgTypeMap, Required: true, Description: "Map defining search criteria. Supported keys: 'id' (string), 'type' (string), 'value' (any), 'attributes' (map of string:string for child node ID checks), 'metadata' (map of string:string for direct string value metadata checks). Other keys are treated as direct metadata attribute checks."},
				{Name: "max_depth", Type: parser.ArgTypeInt, Required: false, Description: "Maximum depth to search relative to the start node (0 for start node only, -1 for unlimited). Default: -1."},
				{Name: "max_results", Type: parser.ArgTypeInt, Required: false, Description: "Maximum number of matching node IDs to return (-1 for unlimited). Default: -1."},
			},
			ReturnType:		runtime.tool.ArgTypeSliceString,
	...
	},
	{
		Spec: runtime.tool.ToolSpec{
			...
			Category:	"Tree Manipulation",
			Args: []runtime.tool.ArgSpec{
				{Name: "tree_handle", Type: parser.ArgTypeString, Required: true, Description: "Handle to the tree structure to render."},
			},
			ReturnType:		parser.ArgTypeString,
