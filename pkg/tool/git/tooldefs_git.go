...
var gitToolsToRegister = []tool.ToolImplementation{
	{
		Spec: tool.ToolSpec{
			...
			Category:	"Git",
			Args: []tool.ArgSpec{
				{Name: "repo_path", Type: parser.ArgTypeString, Required: false, Description: "Optional. Relative path to the repository within the sandbox. Defaults to the sandbox root."},
			},
	...
	},
	{
		Spec: tool.ToolSpec{
			...
			Category:	"Git",
			Args: []tool.ArgSpec{
				{Name: "repository_url", Type: parser.ArgTypeString, Required: true, Description: "The URL of the Git repository to clone."},
				{Name: "relative_path", Type: parser.ArgTypeString, Required: true, Description: "The relative path within the sandbox where the repository should be cloned."},
			},
	...
	},
	{
		Spec: tool.ToolSpec{
			...
			Category:	"Git",
			Args: []tool.ArgSpec{
				{Name: "relative_path", Type: parser.ArgTypeString, Required: true, Description: "The relative path within the sandbox to the Git repository."},
				{Name: "remote_name", Type: parser.ArgTypeString, Required: false, Description: "Optional. The name of the remote to pull from (e.g., 'origin'). Defaults to 'origin'."},
				{Name: "branch_name", Type: parser.ArgTypeString, Required: false, Description: "Optional. The name of the branch to pull. Defaults to the current branch."},
			},
			ReturnType:		parser.ArgTypeString,
	...
	},
	{
		Spec: tool.ToolSpec{
			...
			Args: []tool.ArgSpec{
				{Name: "relative_path", Type: parser.ArgTypeString, Required: true, Description: "The relative path within the sandbox to the Git repository."},
				{Name: "commit_message", Type: parser.ArgTypeString, Required: true, Description: "The commit message."},
				{Name: "allow_empty", Type: parser.ArgTypeBool, Required: false, Description: "Optional. Allow an empty commit (no changes). Defaults to false."},
			},
			ReturnType:		parser.ArgTypeString,
	...
	},
	{
		Spec: tool.ToolSpec{
			...
			Args: []tool.ArgSpec{
				{Name: "relative_path", Type: parser.ArgTypeString, Required: true, Description: "The relative path within the sandbox to the Git repository."},
				{Name: "remote_name", Type: parser.ArgTypeString, Required: false, Description: "Optional. The name of the remote to push to (e.g., 'origin'). Defaults to 'origin'."},
				{Name: "branch_name", Type: parser.ArgTypeString, Required: false, Description: "Optional. The name of the local branch to push. Defaults to the current branch."},
			},
			ReturnType:		parser.ArgTypeString,
	...
	// Added missing tools below:
	{
		Spec: tool.ToolSpec{
			...
			Category:	"Git",
			Args: []tool.ArgSpec{
				{Name: "relative_path", Type: parser.ArgTypeString, Required: true, Description: "Relative path to the repository within the sandbox."},
				{Name: "name", Type: parser.ArgTypeString, Required: false, Description: "Optional. The name of the branch to create. If omitted, and other list flags are false, lists local branches."},
				{Name: "checkout", Type: parser.ArgTypeBool, Required: false, Description: "Optional. If true and 'name' is provided, checks out the new branch after creation. Defaults to false."},
				{Name: "list_remote", Type: parser.ArgTypeBool, Required: false, Description: "Optional. If true, lists remote-tracking branches. Defaults to false."},
				{Name: "list_all", Type: parser.ArgTypeBool, Required: false, Description: "Optional. If true, lists all local and remote-tracking branches. Defaults to false."},
			},
			ReturnType:		parser.ArgTypeString,	// Could be map for lists, string for messages
	...
	},
	{
		Spec: tool.ToolSpec{
			...
			Args: []tool.ArgSpec{
				{Name: "relative_path", Type: parser.ArgTypeString, Required: true, Description: "Relative path to the repository within the sandbox."},
				{Name: "branch", Type: parser.ArgTypeString, Required: true, Description: "The name of the branch to checkout or the commit/pathspec to restore."},
				{Name: "create", Type: parser.ArgTypeBool, Required: false, Description: "Optional. If true, creates a new branch named by 'branch' and checks it out. Defaults to false."},
			},
			ReturnType:		parser.ArgTypeString,
	...
	},
	{
		Spec: tool.ToolSpec{
			...
			Args: []tool.ArgSpec{
				{Name: "relative_path", Type: parser.ArgTypeString, Required: true, Description: "Relative path to the repository within the sandbox."},
				{Name: "paths", Type: parser.ArgTypeAny, Required: true, Description: "A single file path (string) or a list of file paths ([]string) to remove relative to the repository root."},
			},
			ReturnType:		parser.ArgTypeString,
	...
	},
	{
		Spec: tool.ToolSpec{
			...
			Args: []tool.ArgSpec{
				{Name: "relative_path", Type: parser.ArgTypeString, Required: true, Description: "Relative path to the repository within the sandbox."},
				{Name: "branch", Type: parser.ArgTypeString, Required: true, Description: "The name of the branch to merge into the current branch."},
			},
			ReturnType:		parser.ArgTypeString,
	...
	},
	{
		Spec: tool.ToolSpec{
			...
			Args: []tool.ArgSpec{
				{Name: "relative_path", Type: parser.ArgTypeString, Required: true, Description: "Relative path to the repository within the sandbox."},
				{Name: "cached", Type: parser.ArgTypeBool, Required: false, Description: "Optional. Show staged changes (diff against HEAD). Defaults to false."},
				{Name: "commit1", Type: parser.ArgTypeString, Required: false, Description: "Optional. First commit or tree object for diff. Defaults to index if 'cached' is true, or HEAD otherwise."},
				{Name: "commit2", Type: parser.ArgTypeString, Required: false, Description: "Optional. Second commit or tree object for diff. Defaults to the working tree."},
				{Name: "path", Type: parser.ArgTypeString, Required: false, Description: "Optional. Limit the diff to the specified file or directory path within the repository."},
			},
			ReturnType:		parser.ArgTypeString,	// Raw diff output
