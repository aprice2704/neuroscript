...
var gitToolsToRegister = []tool.ToolImplementation{
	...
	},
	{
		Spec: tool.ToolSpec{
			...
			Args: []tool.ArgSpec{
				...
				{Name: "remote_name", Type: tool.ArgTypeString, Required: false, Description: "Optional. The name of the remote to pull from (e.g., 'origin'). Defaults to 'origin'."},
				{Name: "branch_name", Type: tool.ArgTypeString, Required: false, Description: "Optional. The name of the branch to pull. Defaults to the current branch."},
			},
			ReturnType:      tool.ArgTypeString,
	...
	},
	{
		Spec: tool.ToolSpec{
			...
			Args: []tool.ArgSpec{
				...
				{Name: "allow_empty", Type: tool.ArgTypeBool, Required: false, Description: "Optional. Allow an empty commit (no changes). Defaults to false."},
			},
			ReturnType:      tool.ArgTypeString,
	...
	},
	{
		Spec: tool.ToolSpec{
			...
			Args: []tool.ArgSpec{
				{Name: "relative_path", Type: tool.ArgTypeString, Required: true, Description: "The relative path within the sandbox to the Git repository."},
				{Name: "remote_name", Type: tool.ArgTypeString, Required: false, Description: "Optional. The name of the remote to push to (e.g., 'origin'). Defaults to 'origin'."},
				{Name: "branch_name", Type: tool.ArgTypeString, Required: false, Description: "Optional. The name of the local branch to push. Defaults to the current branch."},
			},
			ReturnType:      tool.ArgTypeString,
	...
	// Added missing tools below:
	{
		Spec: tool.ToolSpec{
			...
			Category:    "Git",
			Args: []tool.ArgSpec{
				{Name: "relative_path", Type: tool.ArgTypeString, Required: true, Description: "Relative path to the repository within the sandbox."},
				{Name: "name", Type: tool.ArgTypeString, Required: false, Description: "Optional. The name of the branch to create. If omitted, and other list flags are false, lists local branches."},
				{Name: "checkout", Type: tool.ArgTypeBool, Required: false, Description: "Optional. If true and 'name' is provided, checks out the new branch after creation. Defaults to false."},
				{Name: "list_remote", Type: tool.ArgTypeBool, Required: false, Description: "Optional. If true, lists remote-tracking branches. Defaults to false."},
				{Name: "list_all", Type: tool.ArgTypeBool, Required: false, Description: "Optional. If true, lists all local and remote-tracking branches. Defaults to false."},
			},
			ReturnType:      tool.ArgTypeString, // Could be map for lists, string for messages
	...
	},
	{
		Spec: tool.ToolSpec{
			...
			Args: []tool.ArgSpec{
				{Name: "relative_path", Type: tool.ArgTypeString, Required: true, Description: "Relative path to the repository within the sandbox."},
				{Name: "branch", Type: tool.ArgTypeString, Required: true, Description: "The name of the branch to checkout or the commit/pathspec to restore."},
				{Name: "create", Type: tool.ArgTypeBool, Required: false, Description: "Optional. If true, creates a new branch named by 'branch' and checks it out. Defaults to false."},
			},
			ReturnType:      tool.ArgTypeString,
	...
	},
	{
		Spec: tool.ToolSpec{
			...
			Args: []tool.ArgSpec{
				{Name: "relative_path", Type: tool.ArgTypeString, Required: true, Description: "Relative path to the repository within the sandbox."},
				{Name: "paths", Type: tool.ArgTypeAny, Required: true, Description: "A single file path (string) or a list of file paths ([]string) to remove relative to the repository root."},
			},
			ReturnType:      tool.ArgTypeString,
	...
	},
	{
		Spec: tool.ToolSpec{
			...
			Args: []tool.ArgSpec{
				{Name: "relative_path", Type: tool.ArgTypeString, Required: true, Description: "Relative path to the repository within the sandbox."},
				{Name: "branch", Type: tool.ArgTypeString, Required: true, Description: "The name of the branch to merge into the current branch."},
			},
			ReturnType:      tool.ArgTypeString,
	...
	},
	{
		Spec: tool.ToolSpec{
			...
			Args: []tool.ArgSpec{
				{Name: "relative_path", Type: tool.ArgTypeString, Required: true, Description: "Relative path to the repository within the sandbox."},
				{Name: "cached", Type: tool.ArgTypeBool, Required: false, Description: "Optional. Show staged changes (diff against HEAD). Defaults to false."},
				{Name: "commit1", Type: tool.ArgTypeString, Required: false, Description: "Optional. First commit or tree object for diff. Defaults to index if 'cached' is true, or HEAD otherwise."},
				{Name: "commit2", Type: tool.ArgTypeString, Required: false, Description: "Optional. Second commit or tree object for diff. Defaults to the working tree."},
				{Name: "path", Type: tool.ArgTypeString, Required: false, Description: "Optional. Limit the diff to the specified file or directory path within the repository."},
			},
			ReturnType:      tool.ArgTypeString, // Raw diff output
