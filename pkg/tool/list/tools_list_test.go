...
func TestToolListLength(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Wrong Type", toolName: "List.Length", args: MakeArgs("not a list"), wantErrIs: ErrArgumentMismatch},
	}
...
func TestToolListAppendPrepend(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Append Wrong Type", toolName: "List.Append", args: MakeArgs("not list", "el"), wantErrIs: ErrArgumentMismatch},
...
func TestToolListGet(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Wrong Index Type", toolName: "List.Get", args: MakeArgs(list, "abc"), wantErrIs: ErrArgumentMismatch},
		{name: "Wrong List Type", toolName: "List.Get", args: MakeArgs("not list", int64(0)), wantErrIs: ErrArgumentMismatch},
	}
	for _, tt := range tests {
		testListToolHelper(t, interp, tt)
	}
...
func TestToolListSlice(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Wrong List Type", toolName: "List.Slice", args: MakeArgs("no", int64(0), int64(1)), wantErrIs: ErrArgumentMismatch},
		{name: "Wrong Start Type", toolName: "List.Slice", args: MakeArgs(list, "abc", int64(2)), wantErrIs: ErrArgumentMismatch},
	}
	for _, tt := range tests {
		testListToolHelper(t, interp, tt)
	}
...
func TestToolListContains(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Wrong List Type", toolName: "List.Contains", args: MakeArgs("no", "a"), wantErrIs: ErrArgumentMismatch},
	}
	for _, tt := range tests {
		testListToolHelper(t, interp, tt)
	}
...
func TestToolListReverse(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Wrong Type", toolName: "List.Reverse", args: MakeArgs(123), wantErrIs: ErrArgumentMismatch},
	}
	for _, tt := range tests {
		testListToolHelper(t, interp, tt)
	}
...
func TestToolListSort(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Sort Mixed String/Num", toolName: "List.Sort", args: MakeArgs([]interface{}{"a", 1}), wantErrIs: ErrListCannotSortMixedTypes},
		{name: "Sort List With Nil Element", toolName: "List.Sort", args: MakeArgs([]interface{}{"a", nil, "c"}), wantErrIs: ErrListCannotSortMixedTypes},
		{name: "Sort Strings Looking Like Numbers", toolName: "List.Sort", args: MakeArgs([]interface{}{"10", "2", "1"}), wantResult: []interface{}{"1", "10", "2"}},
		{name: "Wrong Type", toolName: "List.Sort", args: MakeArgs(123), wantErrIs: ErrArgumentMismatch},
	}
	for _, tt := range tests {
		testListToolHelper(t, interp, tt)
	}
...
func TestToolListIsEmpty(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Wrong Type", toolName: "List.IsEmpty", args: MakeArgs("not a list"), wantErrIs: ErrArgumentMismatch},
	}
	for _, tt := range tests {
		testListToolHelper(t, interp, tt)
	}
...
func TestToolListHead(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Wrong Type", toolName: "List.Head", args: MakeArgs(123), wantErrIs: ErrArgumentMismatch},
	}
	for _, tt := range tests {
		testListToolHelper(t, interp, tt)
	}
...
func TestToolListRest(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Wrong Type", toolName: "List.Rest", args: MakeArgs(123), wantErrIs: ErrArgumentMismatch},
	}
	for _, tt := range tests {
		testListToolHelper(t, interp, tt)
	}
...
func TestToolListTail(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Wrong Count Type", toolName: "List.Tail", args: MakeArgs(list, "abc"), wantErrIs: ErrArgumentMismatch},
		{name: "Wrong List Type", toolName: "List.Tail", args: MakeArgs("no", int64(1)), wantErrIs: ErrArgumentMismatch},
	}
	for _, tt := range tests {
		testListToolHelper(t, interp, tt)
	}
