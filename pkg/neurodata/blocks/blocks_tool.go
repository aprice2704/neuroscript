...
func init() {
	...
	tool.AddToolsetRegistration("Blocks", RegisterBlockTools)
}
...
func toolBlocksExtractAll(interpreter tool.RunTime, args []interface{}) (interface{}, error) {
