...
// File version: 11
// Purpose: Updated tests to expect  Value types, aligning with new compliant testing helpers.
// filename: pkg/interpreter/internal/eval/evaluation_logical_bitwise_test.go
