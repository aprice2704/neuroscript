...
// filename: pkg/interpreter/internal/exec/interpreter_tools.go
// nlines: 115
// risk_rating: HIGH
...
func (i *Interpreter) executeInternalTool(impl tool.ToolImplementation, args map[string]Value) (Value, error) {
