...
// filename: pkg/interpreter/internal/exec/interpreter_test.go
package exec
...
func TestExecuteStepsBlocksAndLoops(t *testing.T) {
	...
	mustBeVars := map[string]lang.Value{
		...
		"l":		lang.NewListValue([]lang.Value{NumberValue{Value: 1}, NumberValue{Value: 2}}),
	...
	testCases := []testutil.executeStepsTestCase{
		...
		},
		{
			...
			expectedVars:	map[string]lang.Value{"status": StringValue{Value: "Started"}, "x": StringValue{Value: "Inside"}},
