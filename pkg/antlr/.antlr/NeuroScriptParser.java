...
public class NeuroScriptParser extends Parser {
	...
	public static final int
		...
		TRIPLE_SQ_STRING=67, METADATA_LINE=68, NUMBER_LIT=69, IDENTIFIER=70, ASSIGN=71, 
		PLUS=72, MINUS=73, STAR=74, SLASH=75, PERCENT=76, STAR_STAR=77, AMPERSAND=78, 
		PIPE=79, CARET=80, TILDE=81, LPAREN=82, RPAREN=83, COMMA=84, LBRACK=85, 
		RBRACK=86, LBRACE=87, RBRACE=88, COLON=89, DOT=90, PLACEHOLDER_START=91, 
		EQ=92, NEQ=93, GT=94, LT=95, GTE=96, LTE=97, LINE_COMMENT=98, NEWLINE=99, 
		WS=100;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"KW_WHISPER", "KW_WITH", "STRING_LIT", "TRIPLE_BACKTICK_STRING", "TRIPLE_SQ_STRING", 
			...
			"COLON", "DOT", "PLACEHOLDER_START", "EQ", "NEQ", "GT", "LT", "GTE", 
	...
	public final Relational_exprContext relational_expr() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 94)) & ~0x3f) == 0 && ((1L << (_la - 94)) & 15L) != 0)) {
				{
				{
				setState(530);
				_la = _input.LA(1);
	...
	public final Unary_exprContext unary_expr() throws RecognitionException {
		...
		try {
			...
			case TILDE:
				...
				setState(553);
				_la = _input.LA(1);
				if ( !(((((_la - 46)) & ~0x3f) == 0 && ((1L << (_la - 46)) & 34493957123L) != 0)) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public static final String _serializedATN =
		...
		">\u0001>\u0001?\u0001?\u0001?\u0001?\u0001?\u0001?\u0001?\u0001?\u0003"+
		"?\u026d\b?\u0001@\u0001@\u0001A\u0001A\u0001B\u0001B\u0001B\u0001B\u0001"+
		"C\u0001C\u0001C\u0001C\u0001D\u0003D\u027c\bD\u0001E\u0001E\u0001E\u0005"+
		"E\u0281\bE\nE\fE\u0284\tE\u0001F\u0003F\u0287\bF\u0001G\u0001G\u0001G"+
		"\u0005G\u028c\bG\nG\fG\u028f\tG\u0001H\u0001H\u0001H\u0001H\u0001H\u0000"+
		"\u0000I\u0000\u0002\u0004\u0006\b\n\f\u000e\u0010\u0012\u0014\u0016\u0018"+
