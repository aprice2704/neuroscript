...
public class NeuroScriptParser extends Parser {
	...
	public static final int
		...
		KW_WHILE=62, KW_WHISPER=63, KW_WITH=64, AT=65, STRING_LIT=66, TRIPLE_BACKTICK_STRING=67, 
		TRIPLE_SQ_STRING=68, DOUBLE_BRACKET_STRING=69, METADATA_LINE=70, NUMBER_LIT=71, 
		IDENTIFIER=72, ASSIGN=73, PLUS=74, MINUS=75, STAR=76, SLASH=77, PERCENT=78, 
		STAR_STAR=79, AMPERSAND=80, PIPE=81, CARET=82, TILDE=83, LPAREN=84, RPAREN=85, 
		COMMA=86, LBRACK=87, RBRACK=88, LBRACE=89, RBRACE=90, COLON=91, DOT=92, 
		PLACEHOLDER_START=93, EQ=94, NEQ=95, GT=96, LT=97, GTE=98, LTE=99, LINE_COMMENT=100, 
		NEWLINE=101, WS=102;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'tool'", "'true'", "'typeof'", "'while'", "'whisper'", "'with'", "'@'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"KW_WHISPER", "KW_WITH", "AT", "STRING_LIT", "TRIPLE_BACKTICK_STRING", 
			"TRIPLE_SQ_STRING", "DOUBLE_BRACKET_STRING", "METADATA_LINE", "NUMBER_LIT", 
	...
	public final Return_statementContext return_statement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4287674167257481380L) != 0) || ((((_la - 66)) & ~0x3f) == 0 && ((1L << (_la - 66)) & 145097327L) != 0)) {
				{
				setState(398);
				expression_list();
				}
	...
	public final Relational_exprContext relational_expr() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 96)) & ~0x3f) == 0 && ((1L << (_la - 96)) & 15L) != 0)) {
				{
				{
				setState(530);
				_la = _input.LA(1);
	...
	public final Unary_exprContext unary_expr() throws RecognitionException {
		...
		try {
			...
			case TILDE:
				...
				setState(553);
				_la = _input.LA(1);
				if ( !(((((_la - 46)) & ~0x3f) == 0 && ((1L << (_la - 46)) & 137975825411L) != 0)) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public static class PlaceholderContext extends ParserRuleContext {
		...
		public TerminalNode IDENTIFIER() { return getToken(NeuroScriptParser.IDENTIFIER, 0); }
		public TerminalNode KW_LAST() { return getToken(NeuroScriptParser.KW_LAST, 0); }
		public TerminalNode AT() { return getToken(NeuroScriptParser.AT, 0); }
	...
	public static class LiteralContext extends ParserRuleContext {
		...
		public TerminalNode TRIPLE_SQ_STRING() { return getToken(NeuroScriptParser.TRIPLE_SQ_STRING, 0); }
		public TerminalNode DOUBLE_BRACKET_STRING() { return getToken(NeuroScriptParser.DOUBLE_BRACKET_STRING, 0); }
	...
	public static final String _serializedATN =
		...
		"?\u0001?\u0001?\u0001?\u0001?\u0001?\u0001?\u0003?\u0274\b?\u0001@\u0001"+
		"@\u0001A\u0001A\u0001B\u0001B\u0001B\u0001B\u0001C\u0001C\u0001C\u0001"+
		"C\u0001D\u0003D\u0283\bD\u0001E\u0001E\u0001E\u0005E\u0288\bE\nE\fE\u028b"+
		"\tE\u0001F\u0003F\u028e\bF\u0001G\u0001G\u0001G\u0005G\u0293\bG\nG\fG"+
		"\u0296\tG\u0001H\u0001H\u0001H\u0001H\u0001H\u0000\u0000I\u0000\u0002"+
		"\u0004\u0006\b\n\f\u000e\u0010\u0012\u0014\u0016\u0018\u001a\u001c\u001e"+
