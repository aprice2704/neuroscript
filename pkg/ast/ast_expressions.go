...
// File version: 2
// Purpose: Augmented all expression nodes with BaseNode to conform to the Node interface.
// nlines: 200+
// risk_rating: MEDIUM
...
func (ct *CallTarget) GetPos() *types.Position { return ct.Pos }
...
func (n *CallableExprNode) GetPos() *types.Position { return n.Pos }
...
func (n *VariableNode) GetPos() *types.Position { return n.Pos }
...
func (n *PlaceholderNode) GetPos() *types.Position { return n.Pos }
...
func (n *LastNode) GetPos() *types.Position { return n.Pos }
...
func (n *EvalNode) GetPos() *types.Position { return n.Pos }
...
func (n *StringLiteralNode) GetPos() *types.Position { return n.Pos }
...
func (n *NumberLiteralNode) GetPos() *types.Position { return n.Pos }
...
func (n *BooleanLiteralNode) GetPos() *types.Position { return n.Pos }
...
func (n *ListLiteralNode) GetPos() *types.Position { return n.Pos }
...
func (n *MapEntryNode) GetPos() *types.Position { return n.Pos }
...
func (n *MapLiteralNode) GetPos() *types.Position { return n.Pos }
...
func (n *ElementAccessNode) GetPos() *types.Position { return n.Pos }
...
func (n *UnaryOpNode) GetPos() *types.Position { return n.Pos }
...
func (n *BinaryOpNode) GetPos() *types.Position { return n.Pos }
...
func (n *TypeOfNode) GetPos() *types.Position { return n.Pos }
...
func (n *NilLiteralNode) GetPos() *types.Position { return n.Pos }
