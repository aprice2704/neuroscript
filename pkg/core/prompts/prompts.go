...
// Last Modified: 2025-05-01 19:27:33 PDT
...
const (
	...
	PromptDevelop = "You are generating NeuroScript code based on the NeuroScript.g4 grammar.\n" +
		...
		"16. **Statements**: Valid statements are 'set', 'return', 'emit', 'must', 'mustbe', 'fail', 'clear_error', 'ask', 'if', 'while', 'for each', 'on_error', 'break', 'continue', and call expressions used standalone.\n" + // Added break/continue
		...
		"20. **Output Format**: Generate ONLY raw code. Start with optional ':: metadata', then 'func'. End with 'endfunc' and a final newline. Do NOT include markdown fences or explanations."
