...
func TestToolListLength(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Nil List Arg", toolName: "List.Length", args: MakeArgs(interface{}(nil)), valWantErrIs: ErrValidationRequiredArgNil},
		{name: "Wrong Type", toolName: "List.Length", args: MakeArgs("not a list"), valWantErrIs: ErrValidationTypeMismatch},
		{name: "Wrong Count", toolName: "List.Length", args: MakeArgs(), valWantErrIs: ErrValidationArgCount},
	}
...
func TestToolListAppendPrepend(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Append To Nil List Arg", toolName: "List.Append", args: MakeArgs(interface{}(nil), "new"), valWantErrIs: ErrValidationRequiredArgNil},
		{name: "Append Nil Element", toolName: "List.Append", args: MakeArgs(baseList, nil), wantResult: []interface{}{"a", int64(1), nil}},
		...
		{name: "Prepend To Nil List Arg", toolName: "List.Prepend", args: MakeArgs(interface{}(nil), "new"), valWantErrIs: ErrValidationRequiredArgNil},
		{name: "Prepend Nil Element", toolName: "List.Prepend", args: MakeArgs(baseList, nil), wantResult: []interface{}{nil, "a", int64(1)}},
		// *** MODIFIED: Expect error for 0 args, not 1, since element is not Required ***
		{name: "Prepend Wrong Count", toolName: "List.Prepend", args: MakeArgs(), valWantErrIs: ErrValidationArgCount},
	}
	for _, tt := range tests {
		testListToolHelper(t, interp, tt)
	}
...
func TestToolListGet(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Nil List No Default", toolName: "List.Get", args: MakeArgs(interface{}(nil), int64(0)), valWantErrIs: ErrValidationRequiredArgNil},
		{name: "Nil List With Default", toolName: "List.Get", args: MakeArgs(interface{}(nil), int64(0), "def"), valWantErrIs: ErrValidationRequiredArgNil},
...
func TestToolListSlice(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Slice Nil List Arg", toolName: "List.Slice", args: MakeArgs(interface{}(nil), int64(0), int64(1)), valWantErrIs: ErrValidationRequiredArgNil},
...
func TestToolListContains(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Contains Actual Nil", toolName: "List.Contains", args: MakeArgs(list, nil), wantResult: true}, // Check for actual nil in list; element arg Required=false now allows this
		...
		{name: "Nil List Arg", toolName: "List.Contains", args: MakeArgs(interface{}(nil), "a"), valWantErrIs: ErrValidationRequiredArgNil},
...
func TestToolListReverse(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Reverse Nil List Arg", toolName: "List.Reverse", args: MakeArgs(interface{}(nil)), valWantErrIs: ErrValidationRequiredArgNil},
...
func TestToolListSort(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Sort Nil List Arg", toolName: "List.Sort", args: MakeArgs(interface{}(nil)), valWantErrIs: ErrValidationRequiredArgNil},
...
func TestToolListIsEmpty(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Is Empty True (Nil Arg)", toolName: "List.IsEmpty", args: MakeArgs(interface{}(nil)), valWantErrIs: ErrValidationRequiredArgNil},
...
func TestToolListHead(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Head Nil Arg", toolName: "List.Head", args: MakeArgs(interface{}(nil)), valWantErrIs: ErrValidationRequiredArgNil},
...
func TestToolListRest(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Rest Nil Arg", toolName: "List.Rest", args: MakeArgs(interface{}(nil)), valWantErrIs: ErrValidationRequiredArgNil},
...
func TestToolListTail(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Tail Nil List Arg", toolName: "List.Tail", args: MakeArgs(interface{}(nil), int64(2)), valWantErrIs: ErrValidationRequiredArgNil},
