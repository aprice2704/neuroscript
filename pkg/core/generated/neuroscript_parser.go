...
func neuroscriptParserInit() {
	...
	staticData.SymbolicNames = []string{
		...
		"METADATA_LINE", "LINE_COMMENT", "HASH_BANG", "NEWLINE", "WS",
	}
	...
	staticData.serializedATN = []int32{
		4, 1, 72, 382, 2, 0, 7, 0, 2, 1, 7, 1, 2, 2, 7, 2, 2, 3, 7, 3, 2, 4, 7,
		...
		0, 0, 102, 104, 5, 71, 0, 0, 103, 102, 1, 0, 0, 0, 104, 107, 1, 0, 0, 0,
		105, 103, 1, 0, 0, 0, 105, 106, 1, 0, 0, 0, 106, 3, 1, 0, 0, 0, 107, 105,
		1, 0, 0, 0, 108, 109, 5, 1, 0, 0, 109, 110, 5, 39, 0, 0, 110, 111, 5, 71,
		0, 0, 111, 5, 1, 0, 0, 0, 112, 113, 5, 2, 0, 0, 113, 114, 5, 3, 0, 0, 114,
		115, 5, 67, 0, 0, 115, 116, 5, 50, 0, 0, 116, 117, 3, 8, 4, 0, 117, 118,
		5, 51, 0, 0, 118, 120, 5, 71, 0, 0, 119, 121, 5, 37, 0, 0, 120, 119, 1,
		0, 0, 0, 120, 121, 1, 0, 0, 0, 121, 122, 1, 0, 0, 0, 122, 123, 3, 12, 6,
		0, 123, 125, 5, 4, 0, 0, 124, 126, 5, 71, 0, 0, 125, 124, 1, 0, 0, 0, 125,
		...
		145, 146, 5, 71, 0, 0, 146, 149, 1, 0, 0, 0, 147, 149, 5, 71, 0, 0, 148,
		...
		185, 186, 5, 12, 0, 0, 186, 187, 5, 71, 0, 0, 187, 191, 3, 12, 6, 0, 188,
		189, 5, 13, 0, 0, 189, 190, 5, 71, 0, 0, 190, 192, 3, 12, 6, 0, 191, 188,
		1, 0, 0, 0, 191, 192, 1, 0, 0, 0, 192, 193, 1, 0, 0, 0, 193, 194, 5, 5,
		0, 0, 194, 31, 1, 0, 0, 0, 195, 196, 5, 14, 0, 0, 196, 197, 3, 38, 19,
		0, 197, 198, 5, 15, 0, 0, 198, 199, 5, 71, 0, 0, 199, 200, 3, 12, 6, 0,
		200, 201, 5, 5, 0, 0, 201, 33, 1, 0, 0, 0, 202, 203, 5, 16, 0, 0, 203,
		204, 5, 17, 0, 0, 204, 205, 5, 67, 0, 0, 205, 206, 5, 18, 0, 0, 206, 207,
		3, 38, 19, 0, 207, 208, 5, 15, 0, 0, 208, 209, 5, 71, 0, 0, 209, 210, 3,
...
const (
	...
	NeuroScriptParserLINE_COMMENT      = 69
	NeuroScriptParserHASH_BANG         = 70
	NeuroScriptParserNEWLINE           = 71
	NeuroScriptParserWS                = 72
)
...
func (p *NeuroScriptParser) Statement_list() (localctx IStatement_listContext) {
	...
	for (int64((_la-8)) & ^0x3f) == 0 && ((int64(1)<<(_la-8))&-9223372036854742705) != 0 {
		{
			p.SetState(138)
			p.Body_line()
		}
