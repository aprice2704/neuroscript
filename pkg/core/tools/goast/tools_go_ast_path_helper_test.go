...
// Use standard 'path' for cleaning expected import paths
// Use filepath for OS-specific test setup paths
...
// 	testLogger := core.NewLolog.New(testWriter{t}, "[PATH HELPER TEST] ", log.Ltime|log.Lmicroseconds)
