...
import (
	"testing"
	// No longer need reflect, strings, errors directly here if using helper
...
func TestArithmeticOps(t *testing.T) {
	...
	testCases := []EvalTestCase{
		...
		{Name: "Add Error Int+StrABC", InputNode: &BinaryOpNode{Pos: dummyPos, Left: &VariableNode{Pos: dummyPos, Name: "int5"}, Operator: "+", Right: &VariableNode{Pos: dummyPos, Name: "strABC"}}, InitialVars: vars, WantErr: true, ExpectedErrorIs: ErrInvalidOperandType},
		...
		{Name: "Sub Error Str", InputNode: &BinaryOpNode{Pos: dummyPos, Left: &VariableNode{Pos: dummyPos, Name: "int5"}, Operator: "-", Right: &VariableNode{Pos: dummyPos, Name: "strABC"}}, InitialVars: vars, WantErr: true, ExpectedErrorIs: ErrInvalidOperandTypeNumeric},
		...
		{Name: "Mul Error Str", InputNode: &BinaryOpNode{Pos: dummyPos, Left: &VariableNode{Pos: dummyPos, Name: "int5"}, Operator: "*", Right: &VariableNode{Pos: dummyPos, Name: "strABC"}}, InitialVars: vars, WantErr: true, ExpectedErrorIs: ErrInvalidOperandTypeNumeric},
		...
		{Name: "Div By Int Zero", InputNode: &BinaryOpNode{Pos: dummyPos, Left: &VariableNode{Pos: dummyPos, Name: "int5"}, Operator: "/", Right: &VariableNode{Pos: dummyPos, Name: "int0"}}, InitialVars: vars, WantErr: true, ExpectedErrorIs: ErrDivisionByZero},
		{Name: "Div By Float Zero", InputNode: &BinaryOpNode{Pos: dummyPos, Left: &VariableNode{Pos: dummyPos, Name: "int5"}, Operator: "/", Right: &VariableNode{Pos: dummyPos, Name: "float0"}}, InitialVars: vars, WantErr: true, ExpectedErrorIs: ErrDivisionByZero},
		{Name: "Div Error Str Denom", InputNode: &BinaryOpNode{Pos: dummyPos, Left: &VariableNode{Pos: dummyPos, Name: "int5"}, Operator: "/", Right: &VariableNode{Pos: dummyPos, Name: "strABC"}}, InitialVars: vars, WantErr: true, ExpectedErrorIs: ErrInvalidOperandTypeNumeric},
		{Name: "Div Error Str Num", InputNode: &BinaryOpNode{Pos: dummyPos, Left: &VariableNode{Pos: dummyPos, Name: "strABC"}, Operator: "/", Right: &VariableNode{Pos: dummyPos, Name: "int3"}}, InitialVars: vars, WantErr: true, ExpectedErrorIs: ErrInvalidOperandTypeNumeric},
		...
		{Name: "Mod Error Float", InputNode: &BinaryOpNode{Pos: dummyPos, Left: &NumberLiteralNode{Pos: dummyPos, Value: float64(7.5)}, Operator: "%", Right: &NumberLiteralNode{Pos: dummyPos, Value: int64(3)}}, InitialVars: vars, WantErr: true, ExpectedErrorIs: ErrInvalidOperandTypeInteger},
		{Name: "Mod By Int Zero", InputNode: &BinaryOpNode{Pos: dummyPos, Left: &VariableNode{Pos: dummyPos, Name: "int5"}, Operator: "%", Right: &VariableNode{Pos: dummyPos, Name: "int0"}}, InitialVars: vars, WantErr: true, ExpectedErrorIs: ErrDivisionByZero},
		...
		{Name: "Pow Error Str", InputNode: &BinaryOpNode{Pos: dummyPos, Left: &VariableNode{Pos: dummyPos, Name: "int5"}, Operator: "**", Right: &VariableNode{Pos: dummyPos, Name: "strABC"}}, InitialVars: vars, WantErr: true, ExpectedErrorIs: ErrInvalidOperandTypeNumeric},
		...
		{Name: "Unary Minus Error Str", InputNode: &UnaryOpNode{Pos: dummyPos, Operator: "-", Operand: &VariableNode{Pos: dummyPos, Name: "strABC"}}, InitialVars: vars, WantErr: true, ExpectedErrorIs: ErrInvalidOperandTypeNumeric},
