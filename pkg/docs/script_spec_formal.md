...
Version: 0.3.0
DependsOn: pkg/core/NeuroScript.g4.txt (Version 0.3.0)
...
metadata_line         ::= ( tab | space )* '::' ( tab | space )+ text_until_newline ; (* Reflects G4: [\t ]* '::' [ \t]+ ~[\r\n]* *)
...
(* --- Implicit Lexer Rules (Simplified for EBNF) --- *)
newline               ::= "\\r"? "\\n" | "\\r" ;
space                 ::= " " ;
tab                   ::= "\\t" ;
(* letter                ::= "a".."z" | "A".."Z" | "_" ; *)
